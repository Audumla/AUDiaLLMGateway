...
## [0.13.1](https://github.com/example/AUDiaLLMGateway/compare/v0.13.0...v0.13.1) (2026-03-25)


### Bug Fixes

* config update ([0ed0d62](https://github.com/example/AUDiaLLMGateway/commit/0ed0d62ac49e5fb061ce9cd957395018600fcdff))

## [0.13.0](https://github.com/example/AUDiaLLMGateway/compare/v0.12.3...v0.13.0) (2026-03-25)
...
* implement Docker auto-start for Windows ([e66bc0a](https://github.com/example/AUDiaLLMGateway/commit/e66bc0a0f760329d31bf792339a7ca54bc1117e2))
* implement prebuilt binaries strategy with smart caching ([cac723a](https://github.com/example/AUDiaLLMGateway/commit/cac723a6eafc78eb1b924e62d60f99c66c57b534))
...
* added llamacpp versioning ([4981ce2](https://github.com/example/AUDiaLLMGateway/commit/4981ce2ade4ac9c435d88800b23eafcb6cecc673))
...
* back end catalog management ([2a44b15](https://github.com/example/AUDiaLLMGateway/commit/2a44b155884e8d4ad8cb71a5c1bf361997e97702))
* backend-aware GPU device names and Docker-explicit binary/model paths ([8c88ddb](https://github.com/example/AUDiaLLMGateway/commit/8c88ddb626fa9aab229e4999353b131a2532c067))
...
* config updates ([4ec0251](https://github.com/example/AUDiaLLMGateway/commit/4ec02515fc4ccb0cecbbeab5770bfb789a91e8fe))
* correct qwen3.5-27B model directory casing on Linux ([4a64b16](https://github.com/example/AUDiaLLMGateway/commit/4a64b1605962c1a80d4c09a7d65b5a8eb11fb82a))
...
* downloads to docker configured locations ([695a9ad](https://github.com/example/AUDiaLLMGateway/commit/695a9ad8c7d49797cf71df65e2321390d01c716a))
...
* gateway dashboard ([8afa380](https://github.com/example/AUDiaLLMGateway/commit/8afa380193fbe157c2fad6d62a5caf39b4b2d706))
...
* llamacpp fixes ([65ddfc4](https://github.com/example/AUDiaLLMGateway/commit/65ddfc41e46863c7245a5a307b9e4947ee8e22e8))
* mount only config/local and config/generated, not entire config/ ([c10958f](https://github.com/example/AUDiaLLMGateway/commit/c10958f76ddf3bcc18166282f64f6309790fca44))
* new tests ([5021cf7](https://github.com/example/AUDiaLLMGateway/commit/5021cf71a30202c731102e493d7f0c20e2f5c29f))
...
* reduce logs ([8fdcdd8](https://github.com/example/AUDiaLLMGateway/commit/8fdcdd86b4ce1229b3493d37334cbc2d94a7d526))
...
* rename component ([87cfa20](https://github.com/example/AUDiaLLMGateway/commit/87cfa204611910751e68388184a640b0a328fc12))
...
* resolve docker compose boot issues and server configuration ([6335d9b](https://github.com/example/AUDiaLLMGateway/commit/6335d9b0380888c96a780649c06997e0ef426c5d))
...
* symlink ggml backend plugins into bin dir and auto-set AMD Vulkan ICD ([3d26a3e](https://github.com/example/AUDiaLLMGateway/commit/3d26a3e4a2ffd12c0bfb2c01a28f0444e986f11d))
...
* updated ngnix config ([ac28065](https://github.com/example/AUDiaLLMGateway/commit/ac28065eb261c1616f43ff532ea447fb0b6ab3fa))
* use /health/liveliness for gateway healthcheck ([2beb80e](https://github.com/example/AUDiaLLMGateway/commit/2beb80e356bbfba74c3f77f31e61843d6eb260b6))
* use /tmp paths in generated nginx.conf ([a60424f](https://github.com/example/AUDiaLLMGateway/commit/a60424f94cbfb1e8b010025c61c95e1e50d2eb9e))
...
* add comprehensive llama.cpp backend versions reference ([8a5624b](https://github.com/example/AUDiaLLMGateway/commit/8a5624bdf3f1d9088419c76ae4e7ab4335686301))
...
* add step-by-step manual testing instructions for phases 2-4 ([2191577](https://github.com/example/AUDiaLLMGateway/commit/21915779cf395b89472f21a480badd118b6bd6c3))
* add testing complete summary with quick reference ([551309a](https://github.com/example/AUDiaLLMGateway/commit/551309ab1bd4c02c2bd559950f5e2af438e2c12f))
...
* incorporate all features and fixes into specs and documentation ([36b5867](https://github.com/example/AUDiaLLMGateway/commit/36b5867f25b6101da1c26dfccc9a7147ac49fd92))
* record changelog entries for GPU backend and config fixes ([061d7d1](https://github.com/example/AUDiaLLMGateway/commit/061d7d1a078f9d08e03ca2917ebd0b01fa2e47a7))
