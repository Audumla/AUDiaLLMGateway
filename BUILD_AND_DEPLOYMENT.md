...
- Pushes to Docker Hub: `example/audia-monitoring`
- Uses GitHub Actions Docker layer caching

### Docker Hub Configuration
- Repository: `example/audia-monitoring`
...
- Destination: `example/audia-monitoring:v0.14.0`
- Also tagged: `example/audia-monitoring:latest`
...
```bash
# Pull the image
docker pull example/audia-monitoring:v0.14.0
docker pull example/audia-monitoring:latest

# Run
docker run -p 8080:8080 example/audia-monitoring:v0.14.0
```
...
### GitHub
- Repository: https://github.com/example/AUDiaLLMGateway
- Release Tag: v0.14.0
- Commits:
...
### Docker Hub (Pending)
- Image: `example/audia-monitoring:v0.14.0`
- Tag: `latest`
- URL: https://hub.docker.com/r/example/audia-monitoring
